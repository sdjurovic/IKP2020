...
int main()
{
	...
	FinishSignal = CreateSemaphore(NULL, 0, 3, NULL);  // nit thread obavestava main() i thread_for_accept_clients i thread_recv_on_connectSockets kada se server iskljuci
